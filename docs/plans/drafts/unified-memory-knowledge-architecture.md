...
- **Top-level workspace layout and casing**: confirm the simple `Documents/Personal`, `Documents/ExampleCo`, and `Documents/Example Consultancy` direction from the earlier brainstorm, or replace it before Phase 1.
...
- Source discussion: Telegram thread `telegram--1004567890123-topic-5100` and earlier threads `topic-10005`, `topic-10197`, `topic-10436`, `topic-10559`, `topic-11113`, and `topic-9171`.