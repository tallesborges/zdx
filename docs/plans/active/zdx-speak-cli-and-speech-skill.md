...
> Source thread: `telegram--1003456789012-topic-1274` (Telegram). This is the plan to work on **now**. The sibling plan `zdx-transcribe-cli.md` covers the consistent `zdx transcribe` follow-up.
