...
> Source thread: `telegram--1003456789012-topic-1274` (Telegram). Follow-up to `zdx-speak-cli-and-speech-skill.md`. Do this **after** the `zdx speak` plan so both audio directions share the same CLI + skill shape.
