...
- **✅ Demo**: verified against real `~/.zdx/logs` (149 rolling files) via VHS screenshots. `f` → picker listing 8 targets with counts (`zdx_bot (208)`, `zdx_bot::handlers::message (55)`, …); typing `engine` narrows it; `Enter` applies `@bot` → title `346/346 · @bot`, status `Target filter: zdx_bot (346 of 350 lines)`. `[` → `zdx.log.2026-07-30 [2/149] · 500/500`, status `Log file: zdx.log.2026-07-30 [2/149]`. `L` → title gains `tail=2000`.
