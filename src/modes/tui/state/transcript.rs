...
use crate::modes::tui::selection::{PositionMap, SelectionState};
use crate::modes::tui::transcript::CellId;
...
pub struct TranscriptState {
    ...
    pub cells: Vec<crate::modes::tui::transcript::HistoryCell>,
    ...
    pub wrap_cache: crate::modes::tui::transcript::WrapCache,
...
impl Default for TranscriptState {
    fn default() -> Self {
        Self {
            ...
            wrap_cache: crate::modes::tui::transcript::WrapCache::new(),
            viewport_height: 20,
            terminal_size: (80, 24),
...
impl TranscriptState {
    ...
    pub fn start_selection(&mut self, line: usize, column: usize) {
        use crate::modes::tui::selection::VisualPosition;
    ...
    pub fn copy_and_schedule_clear(&mut self) -> Result<(), String> {
        ...
        crate::modes::tui::selection::Clipboard::copy(&text).map_err(|e| e.to_string())?;
