...
2. **HTML attachment:** Use the `visual-render` skill to generate a self-contained HTML dashboard at `/Users/me/.agent/diagrams/<descriptive-name>.html`. Include it via `<media>` tag at the end of the Telegram message.
