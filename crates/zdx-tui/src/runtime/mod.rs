...
impl KittyImageManager {
    ...
    fn flush(
        &mut self,
        overlay: Option<&crate::overlays::Overlay>,
        ...
        if has_image {
            ...
            if !self.sent || area_changed || cell_size_changed {
                ...
                if let Some(Overlay::ImagePreview(state)) = overlay
...
pub struct TuiRuntime {
    ...
    /// Kitty graphics protocol image lifecycle manager.
    kitty: KittyImageManager,
}
