...
// ============================================================================
/// Vim-style `g` prefix shared by scrollable overlays — see
/// [`zdx_transcript::keys::GPrefix`]. Overlays with a type-to-filter input
/// (thread/skill/file pickers, palette) must not use it.
pub use zdx_transcript::keys::GPrefix;
