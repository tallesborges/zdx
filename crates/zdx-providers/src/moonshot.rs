...
impl MoonshotConfig {
    ...
    pub fn from_env(
        ...
        let api_key = ProviderKind::Moonshot.resolve_api_key(config_api_key)?;
        let base_url = ProviderKind::Moonshot.resolve_base_url(config_base_url)?;
...
/// Constructs the Moonshot client from the given context.
///
/// # Errors
