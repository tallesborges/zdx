...
impl StepfunConfig {
    ...
    pub fn from_env(
        ...
        let api_key = ProviderKind::Stepfun.resolve_api_key(config_api_key)?;
        let base_url = ProviderKind::Stepfun.resolve_base_url(config_base_url)?;
...
/// Constructs the `StepFun` client from the given context.
///
/// # Errors
