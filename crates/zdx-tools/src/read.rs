...
use super::{
    ImageContent, ToolContext, ToolDefinition, ToolOutput, insert_file_path_fields,
...
pub fn execute(input: &Value, ctx: &ToolContext) -> ToolOutput {
    ...
    let normalized_path = crate::normalize_input_path(path);
