...
## [1.0.0](https://github.com/tallesborges/zdx/compare/v0.3.0...v1.0.0) (2026-05-23)
...
* **cli:** add thread export command ([1873cf5](https://github.com/tallesborges/zdx/commit/1873cf5641268e31c83858b35d3849faedccf6fc))
...
* **engine:** atomic activity markers and skip helper subagent runs ([65947d9](https://github.com/tallesborges/zdx/commit/65947d90774b65f11882adf0f4b715cf652dfb9b))
* **events:** persist Notice events without conversation replay ([f830b7f](https://github.com/tallesborges/zdx/commit/f830b7fb4ff0533f899a7dcb031e002729013090))
...
* **imagine:** support OpenAI image edits ([ec003c3](https://github.com/tallesborges/zdx/commit/ec003c38ddf000b46a59392488de3f3180ecfde4))
* **imagine:** support OpenAI image generation ([ce5c626](https://github.com/tallesborges/zdx/commit/ce5c6268da76efdea6c3bab9bfba132e1e1bcc91))
...
* **memory:** add qmd memory indexing ([5c62135](https://github.com/tallesborges/zdx/commit/5c6213510fdea06564d557027228459ba34e98ef))
* **memory:** add qmd recall strategies ([6849649](https://github.com/tallesborges/zdx/commit/684964960cee367b6d26be1489ccdb54d0934ce5))
* **memory:** add qmd status diagnostics ([7631153](https://github.com/tallesborges/zdx/commit/7631153ddff51e5fa9d388037a59d198b37f81f0))
* **memory:** complete auto memory prompt integration ([684ff51](https://github.com/tallesborges/zdx/commit/684ff5168f8e9cdb2eacb17806f10946961e2541))
* **memory:** target qmd search sources ([8beffba](https://github.com/tallesborges/zdx/commit/8beffbab9d2865508313efabc5929ac2fef3388d))
...
* **openai:** add fast mode (service_tier: priority) with /fast toggle and [F] badge ([0fd8ee1](https://github.com/tallesborges/zdx/commit/0fd8ee19ba54d57801dd23a57d6c2c12a00629d8))
* **providers:** add Google Antigravity support ([f14a8ce](https://github.com/tallesborges/zdx/commit/f14a8ce482045f519fca02d503e296ad0b95ef42))
* **providers:** add Xiaomi MiMo Token Plan provider ([e1e556a](https://github.com/tallesborges/zdx/commit/e1e556a17ff3ee04b83ebc85447b0725581d5256))
* **providers:** preserve Gemini implicit prompt cache fidelity end-to-end ([d8cc702](https://github.com/tallesborges/zdx/commit/d8cc702330e03564e9f33dbc53b22972d9584451))
* **providers:** refresh Gemini lineup to 3.5 Flash, drop 2.5 Flash family ([8271651](https://github.com/tallesborges/zdx/commit/8271651ad198c7b2e9f2a0ea19787d408bbee6de))
...
* **thread-search:** exclude current thread from results ([bfa88dd](https://github.com/tallesborges/zdx/commit/bfa88dd23b2cd8cc9ec629d1111622c8d4243bbe))
* **threads:** add qmd index command ([1eb8d36](https://github.com/tallesborges/zdx/commit/1eb8d361c1331b1b5cac36830ce7e49398256c27))
* **threads:** add qmd memory search ([666d9b2](https://github.com/tallesborges/zdx/commit/666d9b2418b56fc8ccc044d4d5233670719189db))
...
* **tui:** respect [providers.X].models in the model picker ([bc8a8d6](https://github.com/tallesborges/zdx/commit/bc8a8d6266007c03b48c61557642da6b3f0ba49e))
...
* **zdx-tui:** add btw popup side chat ([2ed5ddd](https://github.com/tallesborges/zdx/commit/2ed5ddda75a5ef605f90c02b8e907550174e3d35))
...
* **models:** include DeepSeek in registry updates ([6cda1ab](https://github.com/tallesborges/zdx/commit/6cda1abe7d94c3cd95ad18d30bb5e9679c17542d))
...
* **zdx-cli:** keep xiaomi-plan models on `zdx models update` ([d84ddca](https://github.com/tallesborges/zdx/commit/d84ddca6a650fd2bbbcf4cf28ca3f85d0e5d2867))
...
* **zdx-core:** rename grep param path → file_path for consistency ([9b0c2b3](https://github.com/tallesborges/zdx/commit/9b0c2b3fd62c6fd86a9a0f14302e1f1cd0088df8))


### Performance Improvements

* **ci:** speed up local checks ([b833df5](https://github.com/tallesborges/zdx/commit/b833df5317ca593551d2bc6cdcfe12db2649d78c))


### Code Refactoring

* remove zdx-core facade, migrate surfaces to zdx-engine ([dabf011](https://github.com/tallesborges/zdx/commit/dabf01165ad8b48fadcac3fac1c44597507b7fe3))
* restructure workspace into layered crates ([551de7e](https://github.com/tallesborges/zdx/commit/551de7ed985a0f999c41e820227b796e917c5462))
* workspace redesign — layered crate structure ([7d9fec3](https://github.com/tallesborges/zdx/commit/7d9fec3af1fab12428e230ef2a485b7d5bf5cac1))
